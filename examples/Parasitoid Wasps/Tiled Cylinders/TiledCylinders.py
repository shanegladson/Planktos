...
updateDirectionRate = 5  # The number of time steps between changes in direction for a wasp
...
# Define the number of times the cylinders will be tiled and do so (will always be square)
tileNumber = 3
envir.tile_flow(tileNumber, tileNumber)

Lx = 0.1 * tileNumber  # Length of Eulerian Grid in x-Direction
Ly = 0.1 * tileNumber  # Length of Eulerian Grid in y-Direction

# Cylinder Geometry Data (ALWAYS UPDATE WITH IB2D, WILL GIVE INCORRECT RESULTS IF NOT CONSISTENT WITH IB GEOMETRY)
xCenters = np.array([Lx/6.0, 3*Lx/6.0, 5*Lx/6.0, Lx/6.0, 3*Lx/6.0, 5*Lx/6.0, Lx/6.0, 3*Lx/6.0, 5*Lx/6.0])  # (m)
yCenters = np.array([Ly/6.0, Ly/6.0, Ly/6.0, 3*Ly/6.0, 3*Ly/6.0, 3*Ly/6.0, 5*Ly/6.0, 5*Ly/6.0, 5*Ly/6.0])  # (m)
...
swrm.plot_all(movie_filename='TiledCylinders.mp4', fps=20, fluid='quiver')
